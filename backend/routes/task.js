...
router.post("/:taskId/watch", validateRequest({ params: z.object({ taskId: z.string() }) }), watchTask);
router.patch("/:taskId/archive", validateRequest({ params: z.object({ taskId: z.string() }) }), archiveTask);

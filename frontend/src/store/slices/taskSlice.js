...
const taskSlice = createSlice({
  ...
  extraReducers: (builder) => {
    ...
    [updateTaskTitle, updateTaskDescription, updateTaskStatus, updateTaskPriority, updateTaskAssignees, addSubTask, updateSubTask, addTaskAttachment, deleteTaskAttachment].forEach((thunk) => {
      builder
